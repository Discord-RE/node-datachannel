...
const PLATFORMS = {
  'linux-x64-gnu': {
    name: '@lng2004/ndc-linux-x64-gnu',
    os: ['linux'],
    cpu: ['x64'],
    libc: ['glibc'],
  ...
  'linux-x64-musl': {
    name: '@lng2004/ndc-linux-x64-musl',
    os: ['linux'],
    cpu: ['x64'],
    libc: ['musl'],
  ...
  'linux-arm64-gnu': {
    name: '@lng2004/ndc-linux-arm64-gnu',
    os: ['linux'],
    cpu: ['arm64'],
    libc: ['glibc'],
  ...
  'linux-arm64-musl': {
    name: '@lng2004/ndc-linux-arm64-musl',
    os: ['linux'],
    cpu: ['arm64'],
    libc: ['musl'],
